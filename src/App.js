...
function App() {
  ...
  const levels = ['USA 25 Largest Cities', 'USA 50 Largest Cities', 'USA 100 Largest Cities','alb']
  ...
  function setGame(e){
    if(e === 'USA 25 Largest Cities'){
      ...
      setCityOptions(['Albuquerque','Albuquerque1','Albuquerque2','Albuquerque3','Albuquerque4','Albuquerque5','Albuquerque6','Albuquerque7','Albuquerque8','Albuquerque9'])
    }
  }
